        ...
        <div className="relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
          <div className="col-span-6">
            ...
            <p className="text-stone-100 text-base">
              Explore a world of knowledge and skill development with Skill
              Sync. Whether you are looking to advance your career, delve into a
              new hobby, or simply learn something new, our curated selection of
              online courses has something for everyone. From expert-led
              tutorials to comprehensive learning modules, we bring you the
        ...
        <div className="max-w-screen-lg mx-auto flex justify-between items-center">
          <div className="max-w-xl">
            ...
            <p className="text-base text-sky-950">
              Explore our collection of courses designed to cater to learners of
              all levels, from beginners to advanced professionals. Each course
              is meticulously crafted to provide valuable insights and practical
          ...
          <div className="py-20 bg-slate-100 relative before:absolute before:h-full before:w-screen before:bg-sky-950 before:top-0 before:left-0">
            <div className="relative z-20 pl-12">
              <h2 className="text-[#f7d0b6] font-black text-5xl leading-snug mb-10">
                Skill Sync is here to help you
              </h2>
          ...
          <div className="py-20 bg-slate-100 relative before:absolute before:h-full before:w-screen before:bg-[#f7d0b6] before:top-0 before:right-0">
            <div className="relative z-20 pl-12">
              ...
              <p className="text-sky-950 text-sm">
                Start your journey towards personal and professional growth
